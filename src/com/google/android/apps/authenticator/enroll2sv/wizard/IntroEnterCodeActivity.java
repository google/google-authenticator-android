 ...
 */
public class IntroEnterCodeActivity extends IntroPageActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);

    setPageContentView(R.layout.enroll2sv_intro_enter_code);
    setTextViewHtmlFromResource(R.id.details, R.string.enroll2sv_intro_page_enter_code_details);
  }
