...
/**
 * Base class for unit tests of Activity classes representing pages of the 2-step enrollment wizard.
 *
 * @author klyubin@google.com (Alex Klyubin)
 */
class WizardPageActivityTestBase<A extends WizardPageActivity>
    extends ActivityInstrumentationTestCase2<A> {

  WizardPageActivityTestBase(Class<A> activityClass) {
